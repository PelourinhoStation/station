...
public class Main extends Application {
    ...
    public static Map<Integer, Linha> linhas = new HashMap<>();
    public static Map<Integer, Estacao> estacoes = new HashMap<>();
    public static Map<Integer, Bilhete> bilhetes = new HashMap<>();
    public static Map<Integer, Horario> horarios = new HashMap<>();
    public static List<Passageiro> passageiros = new ArrayList<>();
    public static List<Comboio> comboiosParaPartir = new LinkedList<>();
    public static Map<Integer, Comboio> comboios = new HashMap<>();
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        //comboiosParaPartir.add(comboios.get(2));

        //iniciaComboios(comboiosParaPartir);
